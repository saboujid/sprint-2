...
<body>
    <ul>
        <a href="places_register.php" class="back"> Go back </a>
    </ul>

    <input type="text" id="qr-data">
    <button id="button1" onclick="generateQR()"> Generate </button>
    <div id="qrcode"></div>
</body>

<!--<script type="text/javascript" scr="qrcode.min.js"></script>-->
<script>
    var QRCode;
    ! function() {
        function a(a) {
