...
<body>
  <div class="hero">
    ...
    <div class="form-box-r">
      ...
      <div class="title">
        <a href="./visitor/visitor_login.php"><button type="button" class="Visitor">Visitor</button></a>
        ...
        <a href="./hospital/hospital_login.php"><button type="button" class="Hospital">Hospital</button></a>
      </div>
    </div>
  </div>
</body>
