...
<body>
    ...
    <div class="infoline">
        <h1>The Best Web Service for Corona Infections.</h1>
        <h3>This web app was created as a project of Software Engineering Module of Jacobs University Bremen.</h3>
        <p>
            Copyright &copy JUB
            <script>
