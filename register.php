...
<body>
  <div class="hero">
    ...
    <div class="form-box-r">
      ...
      <div class="title">
        <a href="./visitor/visitors_register.php"><button type="button" class="Visitor">Visitor</button></a>
        <a href="./places/places_register.php"><button type="button" class="Place Owner">Place Owner</button></a>
      </div>
    </div>
  </div>
  </div>
